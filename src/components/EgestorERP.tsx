...
const EgestorERP = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#7CFFA0] via-[#6DF090] to-[#5EE080] overflow-hidden relative">
      ...
      <div className="container px-4 mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-block bg-white/20 text-gray-800 font-medium px-6 py-2 rounded-full text-sm mb-6">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-[#7CFFA0] rounded-full flex items-center justify-center mr-3 mt-0.5">
        ...
        <div className="text-center animate-fade-in">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-2xl mx-auto">
            ...
            <a href={egestorLink} target="_blank" rel="noopener noreferrer" className="inline-block w-full max-w-sm">
              <button className="w-full py-4 bg-gray-800 hover:bg-gray-900 text-white font-bold text-lg rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]">
                Teste grátis agora
              </button>
            </a>
          </div>
